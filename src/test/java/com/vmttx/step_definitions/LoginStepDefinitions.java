...
public class LoginStepDefinitions {
    ...
    public void user_logs_in_as_a_driver() {
        String username = ConfigurationReader.getProperty("salespersonUser");
        String password = ConfigurationReader.getProperty("salespersonPassword");
        pages.loginPage().login(username, password);
    }
    ...
    public void user_logs_in_with_following_credentials(Map<String, String> values) {
        ...
        pages.loginPage().login(values.get("userName"), values.get("userPassword"));
    }
